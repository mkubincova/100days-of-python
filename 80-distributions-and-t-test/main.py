...
Original file is located at
    https://colab.research.google.com/drive/1Xb4A3uSXDYTSYnoD3XmcM_GX-W1i5q-i
...
print(f"Yearly nan: {df_yearly.isna().values.any()}")
print(f"Yearly duplicates: {df_yearly.duplicated().values.any()}")

print(f"Monthly nan: {df_monthly.isna().values.any()}")
